			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="widget sm-text-center">
					...
					<div class="h5 font-13 text-black m-0"><span
							class="font-12 text-gray text-uppercase">Телефоны:</span> <a href="tel:+78442430007">+7
							(8442) 43-00-07</a></div>
					<div class="h5 font-13 text-black m-0"><a href="tel:88005500562">8 (800) 550-05-62</a>, <a
							href="tel:+79275101100">+7 927-510-11-00</a></div>
				</div>
				<div class="widget">
					<i class="fa fa-clock-o text-theme-colored2"></i> Время работы: пн-пт: 8.00- 17.00, сб: 8.00- 15.00
				</div>
			</div>
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="widget sm-text-center">
...
<div class="main-content">
	...
	<section class="inner-header divider parallax layer-overlay overlay-dark-5" style="background-position: 50% 78px;">
		<div class="container pt-70 pb-20">
			<div class="section-content">
				<div class="row">
					<nav class="col-md-12" aria-label="breadcrumb">
						<!--h2 class="title text-white">Изготовление металлоконструкций Волгоград Россия</h2-->
						<ol class="breadcrumb text-left text-black mt-10">
							<li class="breadcrumb-item text-gray-silver"><a class="text-white" href="index.html">Главная</a></li>
							<li class="breadcrumb-item text-gray-silver" aria-current="page"><a class="text-white" href="#">Секретная база данных</a></li>
						</ol>
					</nav>
				</div>
			</div>
